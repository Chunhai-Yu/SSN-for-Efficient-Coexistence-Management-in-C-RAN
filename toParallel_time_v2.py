...
print(len(myglobals.power_threads[5]))
#for ii in range(0,12):
    #aa=sum(np.array(myglobals.power_threads[ii]))/NN
    #print(aa)
...
#if __name__ == '__main__':
s0 = threading.Thread(name='sensor 0', target=receive_power(sdr0,0))
s1 = threading.Thread(name='sensor 1', target=receive_power(sdr1,1))
s2 = threading.Thread(name='sensor 2', target=receive_power(sdr2,2))
s3 = threading.Thread(name='sensor 3', target=receive_power(sdr3,3))
s4 = threading.Thread(name='sensor 4', target=receive_power(sdr4,4))
s5 = threading.Thread(name='sensor 5', target=receive_power(sdr5,5))
s6 = threading.Thread(name='sensor 6', target=receive_power(sdr6,6))
s7 = threading.Thread(name='sensor 7', target=receive_power(sdr7,7))
s8 = threading.Thread(name='sensor 8', target=receive_power(sdr8,8))
s9 = threading.Thread(name='sensor 9', target=receive_power(sdr9,9))
s10 = threading.Thread(name='sensor 10', target=receive_power(sdr10,10))
s11 = threading.Thread(name='sensor 11', target=receive_power(sdr11,11))
#s12 = threading.Thread(name='sensor 12', target=receive_power(sdr0,12))
...
sensingtime= (time.time() - start)
print('average time',sensingtime/NN)
print(len(myglobals.power_threads[2]))
'''
