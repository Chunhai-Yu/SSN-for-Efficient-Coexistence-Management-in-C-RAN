...
def senloc_config(*args):
    ...
    if senID2.get()=='5':
        loc=np.array([lx.get(),ly.get()])
        globalEngine.LCEGroup[0].SensorGroup[5].set_location(loc)
    if senID2.get()=='6':
        loc=np.array([lx.get(),ly.get()])
        globalEngine.LCEGroup[0].SensorGroup[6].set_location(loc)
    if senID2.get()=='7':
        loc=np.array([lx.get(),ly.get()])
        globalEngine.LCEGroup[0].SensorGroup[7].set_location(loc)
    if senID2.get()=='8':
        loc=np.array([lx.get(),ly.get()])
        globalEngine.LCEGroup[0].SensorGroup[8].set_location(loc)
    if senID2.get()=='9':
        loc=np.array([lx.get(),ly.get()])
        globalEngine.LCEGroup[0].SensorGroup[9].set_location(loc)
    if senID2.get()=='10':
        loc=np.array([lx.get(),ly.get()])
        globalEngine.LCEGroup[0].SensorGroup[10].set_location(loc)
    if senID2.get()=='11':
        loc=np.array([lx.get(),ly.get()])
        globalEngine.LCEGroup[0].SensorGroup[11].set_location(loc)
    if senID2.get()=='12':
        loc=np.array([lx.get(),ly.get()])
        globalEngine.LCEGroup[0].SensorGroup[12].set_location(loc)
    if senID2.get()=='13':
        loc=np.array([lx.get(),ly.get()])
        globalEngine.LCEGroup[0].SensorGroup[13].set_location(loc)
