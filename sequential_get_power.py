...
def sequential_power():
    ...
    def receive_power1():
        ...
        for ii in range(0, N):
            ...
            p_density1, fre1 = selfpsd(samples1, NFFT=1024, Fs=sdr1.sample_rate,
    ...
    def receive_power2():
        ...
        for ii in range(0, N):
            ...
            p_density2, fre2 = selfpsd(samples2, NFFT=1024, Fs=sdr2.sample_rate,
    ...
    def receive_power3():
        ...
        for ii in range(0, N):
            ...
            p_density3, fre3 = selfpsd(samples3, NFFT=1024, Fs=sdr3.sample_rate,
    ...
    def receive_power4():
        ...
        for ii in range(0, N):
            ...
            p_density4, fre4 = selfpsd(samples4, NFFT=1024, Fs=sdr4.sample_rate,
    ...
    def receive_power5():
        ...
        for ii in range(0, N):
            ...
            p_density5, fre5 = selfpsd(samples5, NFFT=1024, Fs=sdr5.sample_rate,
    ...
    def receive_power6():
        ...
        for ii in range(0, N):
            ...
            p_density6, fre6 = selfpsd(samples6, NFFT=1024, Fs=sdr6.sample_rate,
