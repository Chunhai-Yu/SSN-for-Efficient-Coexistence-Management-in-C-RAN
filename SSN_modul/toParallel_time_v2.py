...
def receive_power7():
    ...
    while rec:
        ...
        for ii in range(0, N):
            samples7 = sdr7.read_samples(56 * 1024)  # 256
...
def receive_power8():
    ...
    while rec:
        ...
        for ii in range(0, N):
            samples8 = sdr8.read_samples(56 * 1024)  # 256
...
def receive_power9():
    ...
    while rec:
        ...
        for ii in range(0, N):
            samples9 = sdr9.read_samples(56 * 1024)  # 256
...
def receive_power10():
    ...
    while rec:
        ...
        for ii in range(0, N):
            samples10 = sdr10.read_samples(56 * 1024)  # 256
            p_density10, fre10 = selfpsd(samples10, NFFT=1024, Fs=sdr10.sample_rate, Fc=sdr10.center_freq)  # get psd using own function
...
def receive_power11():
    ...
    while rec:
        ...
        for ii in range(0, N):
            samples11 = sdr11.read_samples(56 * 1024)  # 256
            p_density11, fre11 = selfpsd(samples11, NFFT=1024, Fs=sdr11.sample_rate, Fc=sdr11.center_freq)  # get psd using own function
...
def receive_power12():
    ...
    while rec:
        ...
        for ii in range(0, N):
            samples12 = sdr12.read_samples(56 * 1024)  # 256
...
def receive_power13():
    ...
    while rec:
        ...
        for ii in range(0, N):
            ...
            p_density13, fre13 = selfpsd(samples13, NFFT=1024, Fs=sdr13.sample_rate, Fc=sdr13.center_freq)  # get psd using own function
...
def receive_power14():
    ...
    while rec:
        ...
        for ii in range(0, N):
            ...
            p_density14, fre14 = selfpsd(samples14, NFFT=1024, Fs=sdr14.sample_rate, Fc=sdr14.center_freq)  # get psd using own function
...
def receive_power15():
    ...
    while rec:
        ...
        for ii in range(0, N):
            ...
            p_density15, fre15 = selfpsd(samples15, NFFT=1024, Fs=sdr15.sample_rate, Fc=sdr15.center_freq)  # get psd using own function
...
s14 = threading.Thread(name='sensor 14', target=receive_power14)
s15 = threading.Thread(name='sensor 15', target=receive_power15)
s16 = threading.Thread(name='sensor 16', target=receive_power16)
...
def receive_power(sdr,id):
    ...
    while rec:
        ...
        for ii in range(0, N):
            ...
            p_density, fre = selfpsd(samples, NFFT=1024, Fs=sdr.sample_rate, Fc=sdr.center_freq)  # get psd using own function
        ...
        # myglobals.power_threads[id]=re_pow
        # myglobals.psd_threads[id]=new_psd
        # myglobals.fre_threads[id]=f_new
        #print(id)


#if __name__ == '__main__':
s0 = threading.Thread(name='sensor 0', target=receive_power(sdr0,id))
s1 = threading.Thread(name='sensor 1', target=receive_power(sdr0,id))
s2 = threading.Thread(name='sensor 2', target=receive_power(sdr0,id))
s3 = threading.Thread(name='sensor 3', target=receive_power(sdr0,id))
s4 = threading.Thread(name='sensor 4', target=receive_power(sdr0,id))
s5 = threading.Thread(name='sensor 5', target=receive_power(sdr0,id))
s6 = threading.Thread(name='sensor 6', target=receive_power(sdr0,id))
s7 = threading.Thread(name='sensor 7', target=receive_power(sdr0,id))
s8 = threading.Thread(name='sensor 8', target=receive_power(sdr0,id))
s9 = threading.Thread(name='sensor 9', target=receive_power(sdr0,id))
s10 = threading.Thread(name='sensor 10', target=receive_power(sdr0,id))
s11 = threading.Thread(name='sensor 11', target=receive_power(sdr0,id))
s12 = threading.Thread(name='sensor 12', target=receive_power(sdr0,id))
s13 = threading.Thread(name='sensor 13', target=receive_power(sdr0,id))
s14 = threading.Thread(name='sensor 14', target=receive_power(sdr0,id))
s15 = threading.Thread(name='sensor 15', target=receive_power(sdr0,id))
s16 = threading.Thread(name='sensor 16', target=receive_power(sdr0,id))
